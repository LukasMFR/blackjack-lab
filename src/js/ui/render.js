...
import { applyShortcutLabel } from './shortcutLabels.js';
...
export function renderStaticLabels({ showShortcutLabels = false } = {}) {
  ...
  applyShortcutLabel($('btn-deal'), t('bet.deal'), SHORTCUT_KEYS.DEAL, showShortcutLabels);
  applyShortcutLabel($('btn-next'), t('round.newRound'), SHORTCUT_KEYS.DEAL, showShortcutLabels);
